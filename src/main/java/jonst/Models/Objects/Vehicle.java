...
public class Vehicle extends StationaryObject {
    ...
    public Vehicle(IdentityCore identityCore, RelationCore relationCore, ActionCore actionCore, List<String> destinationIds) {
    ...
    public Vehicle(Vehicle template) {
        this(template.getIdentityCore(), template.getRelationCore(), template.getActionCore(), template.getDestinationIds());
