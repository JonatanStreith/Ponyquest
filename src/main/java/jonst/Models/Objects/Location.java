...
//    private List<String> legitimateExits = new ArrayList<>();
    ...
    public Location(String name, String type, String id, String locationId, List<String> alias, List<String> attributes, String defaultEnterId, String defaultExitId, Map<String, String> descriptions, String text, String defaultUse, Map<String, String> complexUse, Map<String, ArrayList<String>> responseScripts, String ownerName) {
