...
public class Spellcasting {
    ...
    public static void fireball(String[] magicCommandArray, World world) {
        ...
        GenericObject gen = world.match(world.getLocalGroundOnly(), Lambda.objectByName(magicCommandArray[3]));
    ...
    public static void energize(String[] magicCommandArray, World world) {
        ...
        GenericObject genTarget = world.match(world.getLocalGenericList(), Lambda.objectByName(magicCommandArray[3]));
